package com.example.haide.compass;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        direction = (ImageView) findViewById(R.id.direction_arrow);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(mLastAccelerometerSet && mLastMagnetometerSet){
            ...
            mSensorManager.getOrientation(rMat,orientation);
            mAzimuth = (int)((Math.toDegrees(SensorManager.getOrientation(rMat,orientation)[0])+360)%360);
        }

        mAzimuth = Math.round(mAzimuth);
        imageView.setRotation(mAzimuth);
        direction.setRotation(mAzimuth);
        ...
        textView.setText(mAzimuth+"° "+where);
